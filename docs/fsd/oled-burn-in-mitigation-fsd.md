...
| 2026-05-26 | `9687070` (PR #48)   | AMOLED-1.43  | WAKE-004 | ⚠ supersed. | Verified under the old "PUSH wakes to ACTIVE" contract. Behavior changed to soft-wake-to-DIMMED in `feat/push-soft-wake`; needs re-verification under the new contract. |
