 ...
 *   5. Backlight / brightness (0x51 register) — the white bar should
 *      look white, not dim.
 *
...
void amoled_demo_run(void)
{
    ...
    /* A thin outline at safe-radius = 220 px shows where the visible
     * disc edge is. We approximate the circle by stacking many thin
     * rectangles — cheap, no LVGL canvas needed. Skipped for now to
     * keep the pattern uncluttered; uncomment to enable. */
